...
// Nova Realtime provider (initial): functional streaming path that mirrors Transcribe provider
// using the existing NDJSON route, keeping parity fields. TODO: Swap to Bedrock Realtime via WebRTC.
export class NovaRealtimeAsr implements AsrProvider {
  ...
  async start(): Promise<void> {
    ...
    try {
      ...
      // Temporary: reuse transcribe route until Bedrock Realtime signaling is added
